...
static_assert(!PTS::Traits::is_associative_container_v<std::pair<std::vector<int>, std::vector<float>>>);
...
static_assert(!PTS::Traits::is_sequence_container_v<std::pair<std::vector<int>, std::vector<float>>>);
