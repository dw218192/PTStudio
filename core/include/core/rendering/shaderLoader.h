...
class ShaderLoader {
   public:
    ...
    /// @param resource_key The embedded resource lookup key (e.g. "editor/generated/shaders/forward.wgsl")
    /// @param slang_source Path to the .slang source file, relative to workspace root (e.g. "editor/shaders/forward.slang")
    /// @param wgsl_output Path to the compiled .wgsl file, relative to workspace root (e.g. "editor/generated/shaders/forward.wgsl")
