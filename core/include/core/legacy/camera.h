...
struct Camera {
    ...
    NODISCARD auto get_view_proj() const noexcept -> glm::mat4 const& {
        return m_view_proj;
    }
    NODISCARD auto get_view() const noexcept -> glm::mat4 const& {
        return m_view;
    }
    NODISCARD auto get_projection() const noexcept -> glm::mat4 const& {
        return m_projection;
    }
    NODISCARD auto get_inv_view_proj() const noexcept -> glm::mat4 const& {
        return m_inv_view_proj;
    }
    NODISCARD auto get_fov() const noexcept {
        return m_fov;
    }
    NODISCARD auto get_aspect() const noexcept {
        return m_aspect;
    }
    ...
    NODISCARD auto get_up() const noexcept {
        return m_up;
    }
   ...
   private:
    ...
    FIELD(float, m_fov, {}, MSerialize{});
    FIELD(float, m_aspect, {}, MSerialize{});
    ...
    FIELD(glm::vec3, m_eye, {}, MSerialize{});
    FIELD(glm::vec3, m_center, {}, MSerialize{});
    FIELD(glm::vec3, m_up, {}, MSerialize{});
    END_REFLECT();
    glm::vec3 m_arm_dir;
