 ...
 * @tparam Enum the enum class to iterate over
...
struct EIter {
    struct Iterator {
        ...
        constexpr auto operator*() const noexcept -> Enum {
            return m_val;
        }
    ...
    constexpr static auto begin() noexcept -> Iterator {
        return Iterator{static_cast<Enum>(0)};
    }
    constexpr static auto end() noexcept -> Iterator {
        return Iterator{Enum::__COUNT};
    }
};
}  // namespace PTS