...
struct Light : SceneObject {
    ...
    NODISCARD auto get_color() const noexcept -> auto const& {
        return m_color;
    }
    NODISCARD auto get_intensity() const noexcept {
        return m_intensity;
    }
   ...
   private:
    ...
    FIELD(LightType, m_type, LightType::Point, MSerialize{}, MEnum{4, [](int idx) -> char const* {
                                                                       switch (idx) {
                                                                           case 0:
                                                                               return "Directional";
                                                                           case 1:
    ...
    FIELD(glm::vec3, m_color, {}, MSerialize{}, MColor{});

    FIELD(float, m_intensity, {}, MSerialize{}, MRange{0.0f, 2.0f});
