...
class ImGuizmoConan(ConanFile):
    ...
    def source(self):
        # Clone from GitHub master branch for compatibility with imgui 1.92+
        git = Git(self)
        git.clone("https://github.com/CedricGuillemet/ImGuizmo.git", target=".")
        # Use a specific commit for reproducibility (latest as of 2025)
        git.checkout("master")
    ...
    def generate(self):
        ...
        # ImGuizmo's built-in CMakeLists.txt has complex example dependencies
        cmake_content = """
