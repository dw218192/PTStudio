...
struct UniformVar {
   ...
   private:
    ...
    GLint m_loc;
    std::variant<glm::mat3, glm::mat4, glm::vec2, glm::vec3, glm::vec4, glm::ivec2, glm::ivec3,
                 glm::ivec4, float, int, tcb::span<glm::vec3 const>, tcb::span<glm::vec4 const>,
                 tcb::span<glm::mat4 const>, tcb::span<float const>, tcb::span<int const>>
        value;
};
