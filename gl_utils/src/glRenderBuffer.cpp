...
auto GLRenderBuffer::create(unsigned width, unsigned height,
    ...
    auto ret =
        GLRenderBufferRef{new GLRenderBuffer{width, height, format, rbo}, GLResourceDeleter{}};
    return ret;
}
...
GLRenderBuffer::GLRenderBuffer(unsigned width, unsigned height, GLenum format,
