...
struct GLTexture final : Texture, GLResource {
    ...
    [[nodiscard]] static auto create(unsigned width, unsigned height, GLenum format, std::initializer_list<GLParam> params = k_default_params) noexcept
        -> tl::expected<GLTextureRef, std::string>;
    [[nodiscard]] static auto create(tcb::span<unsigned char const> img_mem, FileFormat type, std::initializer_list<GLParam> params = k_default_params) noexcept
        -> tl::expected<GLTextureRef, std::string>;
    [[nodiscard]] static auto create(std::string_view img_file, FileFormat type, std::initializer_list<GLParam> params = k_default_params) noexcept
        -> tl::expected<GLTextureRef, std::string>;
