...
[[nodiscard]] auto PTS::Vk::VulkanDescSetInfo::create(VulkanDeviceInfo const& dev,
    ...
    try {
        ...
        m_layout = dev->createDescriptorSetLayoutUnique(desc_set_layout_info);

        auto alloc_info = vk::DescriptorSetAllocateInfo{*pool, *m_layout};
        ...
        auto desc_sets = dev->allocateDescriptorSetsUnique(alloc_info);
