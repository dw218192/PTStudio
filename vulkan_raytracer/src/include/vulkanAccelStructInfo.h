...
struct VulkanAccelStructInfo : VulkanInfo<vk::UniqueAccelerationStructureKHR> {
    [[nodiscard]] static auto create(VulkanDeviceInfo const& dev, VulkanCmdPoolInfo const& cmd_pool,
                                     ...
                                     uint32_t primitive_count, uint32_t max_primitive_count)
...
struct VulkanTopAccelStructInfo {
     ...
     */
    [[nodiscard]] auto add_instance(VulkanBottomAccelStructInfo&& bottom_accel,
     ...
     */
    [[nodiscard]] auto update_instance_transform(size_t idx, glm::mat4 const& transform) noexcept
   ...
   private:
     ...
     * @param transform the new transform to apply to the instance
     */
    [[nodiscard]] auto update_instance_gpu(size_t idx, glm::mat4 const& transform) noexcept
        -> tl::expected<void, std::string>;
