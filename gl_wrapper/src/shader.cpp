...
namespace {
	...
	auto link_shaders(GLuint program,
	                  View<EArray<ShaderType, ShaderRef>> shaders) noexcept -> tl::expected<void, std::string> {
...
auto ShaderProgram::from_shaders(
	EArray<ShaderType, ShaderRef> shaders) noexcept -> tl::expected<ShaderProgramRef, std::string> {
